...
<footer class="site-footer"><div class="container">
  ...
  <div class="footer-bottom">
    ...
    <span>Licensed Real Estate Brokerage &middot; Equal Housing Opportunity &#127968; &middot; <a href="<?php echo esc_url(home_url('/privacy-policy/')); ?>">Privacy Policy</a> &middot; <a href="<?php echo esc_url(home_url('/terms/')); ?>">Terms of Service</a> &middot; <a href="<?php echo esc_url(home_url('/credits/')); ?>">Photo Credits</a></span>
  </div>
</div></footer>
